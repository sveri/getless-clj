...
(def from-yesterday [{:id 1, :for-date (:yesterday (act/get-three-dates)), :users-id 1, :content "cont-1"}])
(def from-today [{:id 1, :for-date (:today (act/get-three-dates)), :users-id 1, :content "cont-1"}])
(def from-tomorrow [{:id 1, :for-date (:tomorrow (act/get-three-dates)), :users-id 1, :content "cont-1"}])
